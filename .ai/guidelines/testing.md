...
- Controller tests that affect the database should test the response, load the model(s) and test the model(s) using pest expectations. Avoid using `assertDatabaseHas`.