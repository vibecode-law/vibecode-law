...
use App\Http\Controllers\Challenge\Public\ChallengeLiveController;
...
Route::prefix('inspiration')->name('inspiration.')->group(function () {
    ...
    Route::get('/challenges/{challenge:slug}/live', ChallengeLiveController::class)->name('challenges.live');
});
